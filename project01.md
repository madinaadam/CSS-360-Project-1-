...
> - The current in-house templates and an interpreter written in Java will be reused with minor changes
> - Your team has mixed experience levels and will coordinate with a seperate group developing the Java Interpretor
...
> Your friend wants to develop a website for their new dentistry clinic.
> - Needed now: hours, location, staff, forms
> - Flexible with project timespan
> - Future needs: online appointment scheduling, automated text reminders, issue of discounts, and continous updates to the site
...
> You are the PM for the development of a software system meant to monitor the status of a nuclear power plant
>- You will work with a group of knowledgeable scientists
>- Critical operations
>- Needs to deal with possibility of hardware failure (Needs sturdy safety nets)
>- Long lifespan (expected 10 years)
>- Able to subcontract out parts of the development
